		...
		<div align="center">
			...
			<table>
				...
				<tr>
					...
					<td style="position: fixed;"><font color="red"> <%=ServletUtility.getErrorMessage("accountNo", request)%>
					</font></td>
				</tr>
				...
				<tr>
					...
					<td><%=HTMLUtility.getList("accountType", bean.getAccountType(), map)%></td>
					<td style="position: fixed;"><font color="red"> <%=ServletUtility.getErrorMessage("accountType", request)%>
					</font></td>
				</tr>
				...
				<tr>
					...
					<td style="position: fixed;"><font color="red"> <%=ServletUtility.getErrorMessage("bankName", request)%>
					</font></td>
				</tr>
				...
				<tr>
					...
					<td colspan="2"><input type="submit" name="operation"
						...
						name="operation" value="<%=AccountCtl.OP_CANCEL%>"></td>
					<%
						} else {
					%>
					<td colspan="2"><input type="submit" name="operation"
						value="<%=AccountCtl.OP_SAVE%>"> <input type="submit"
						name="operation" value="<%=AccountCtl.OP_RESET%>"></td>
					<%
						}
					%>
				</tr>
